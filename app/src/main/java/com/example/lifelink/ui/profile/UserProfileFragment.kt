package com.example.lifelink.ui.profile
...
class UserProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val ivProfilePicture = view.findViewById<ImageView>(R.id.iv_user_profile_picture_profile)
        ...
        val tvGender = view.findViewById<MaterialTextView>(R.id.tv_gender_profile)
        val tvBloodGroup = view.findViewById<MaterialTextView>(R.id.tv_blood_group_profile)
