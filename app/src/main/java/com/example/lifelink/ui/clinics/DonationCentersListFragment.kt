...
import com.example.lifelink.ui.DonationCentersAdapter
import com.example.lifelink.ui.models.ClinicItemModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.allClinics.observe(this) { clinics ->
            if (clinics.isEmpty()) {
                ...
                val url = "https://lifelink.free.beeceptor.com/data/clinics" /*"https://mocki.io/v1/a299f484-2e72-4dc3-a6cb-7e6110ea98d4"*/
